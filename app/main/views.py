...
from flask import render_template, flash, Blueprint, current_app, redirect, url_for, request
...
def process_file(filename):
    ...
    if form.validate_on_submit():
        ...
        validation_request = CSVValidationRequest(id=uuid.uuid4(), file=filename, schema=schema.name, mappings=mappings)
